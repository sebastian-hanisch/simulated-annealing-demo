"""Wortgleiche Kopie aus der hill-climbing-demo (tests/test_dlb.py), an sa_dlb.py/sa_tour.py angepasst.

Kandidatenlisten + Don't-Look-Bits (sa_dlb.py): Permutation, Laengenbuchhaltung, Monotonie, Determinismus,
Bewertungsbudget; bei kleinen Instanzen echte 2-opt-Optima (gegen sa_tour.is_local_optimum, unabhaengig von
